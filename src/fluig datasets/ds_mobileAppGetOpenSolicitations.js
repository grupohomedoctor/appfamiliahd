function createDataset(fields, constraints, sortFields) {
  ...
  if (IDAdmission) {
    ...
    var created = false;
    var selectQuery = "select Base, ID, IDAdmission, Status, EventDate, MonitStaff, Description, IDException, ExceptionType, Subject, CreationDate, ElapsedTime, WriteoffDate, PersonWriteOffName, Notified from vw_HD_FL_CAPEXCEPTION where IDAdmission = " + IDAdmission + " order by IDAdmission, ID ";
    try {
